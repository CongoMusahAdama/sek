...
const allowedOrigins = [
    ...
    'http://localhost:3000',
    'http://127.0.0.1:5173',
    'https://sekinaspecial.netlify.app',
    'https://www.sekinaspecial.netlify.app'
];
...
if (process.env.NODE_ENV === 'production') {
    ...
    app.get('/', (req, res) => {
        res.send('Sekina Special API is running in development mode...');
    });
}
...
const seedAdmin = async () => {
    try {
        ...
        const adminData = {
            name: process.env.ADMIN_NAME || 'Sekina Admin',
            email: adminEmail,
            phone: adminPhone,
        ...
        if (!adminExists) {
            ...
            // Update existing admin if password or name changed in .env
